...
vector< vector<float> > fPlayer1Location(15, vector<float>(2));
vector< vector<float> > fPlayer2Location(15, vector<float>(2));
...
int main()
{
	...
	namedWindow("Thresholded Player 1 Controllers", WINDOW_NORMAL); resizeWindow("Thresholded Player 1 Controllers", 640, 360);
